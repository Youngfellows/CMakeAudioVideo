...
int main()
{
    ...
    printf("%s%s():: Line,%d\n", TAG, __FUNCTION__, __LINE__);
    FILE *gif_compressed_frame = fopen("./gif/rainbow-compressed.gif", "rb+");
    ...
    FILE *gif_decompressed_frame = fopen("./resource/rainbow-decompressed.gif.frame", "wb+");
    fwrite(img, decompressed_size, 1, gif_decompressed_frame);
    fflush(gif_decompressed_frame);

    FILE *gif_frame_rgb = fopen("./resource/rainbow-decompressed.gif.frame.rgb", "wb+");
