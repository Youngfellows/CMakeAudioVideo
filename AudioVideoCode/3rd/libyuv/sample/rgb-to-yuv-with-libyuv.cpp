...
void libyuv_Rgb24_to_Yuv420p(char* rgbFileName,
                             char* yuvFileName,
                             int width,
                             int height) {
  ...
  //    RGB24ToI420(
  RAWToI420(
      buffer_rgb, width * 3, buffer_yuv, width, buffer_yuv + width * height,
      (width + 1) / 2,
      buffer_yuv + width * height + ((width + 1) / 2) * ((height + 1) / 2),
...
int main() {
  ...
  libyuv_Rgb24_to_Yuv420p(
      "/Users/hubin/Desktop/rainbow-rgb24.rgb",
      "/Users/hubin/Desktop/rainbow-rgb24-to-yuv420p-libyuv.yuv", width,
      height);
  return 0;
}