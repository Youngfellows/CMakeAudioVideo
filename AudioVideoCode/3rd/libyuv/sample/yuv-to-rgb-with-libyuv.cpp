...
void libyuv_I444_to_Rgb(char* srcFileName,
                        char* dstFileName,
                        int width,
                        int height) {
  ...
  I444ToARGB((const uint8_t*)buffer_src, width,
             ...
             (uint8_t*)buffer_dest, width * 4, width, height);
...
int main() {
  ...
  libyuv_I444_to_Rgb("/Users/hubin/Desktop/rainbow-yuv444p.yuv",
                     "/Users/hubin/Desktop/rainbow-yuv444p-to-rgb32-libyuv.yuv",
                     width, height);
  return 0;
}