...
#define RGB(r, g, b) ((r) | ((g) << 8) | ((b) << 16))
    ...
    libattopng_save(png, "./resource/libattopng-rgb-rainbow.png");
...
#define RGBA(r, g, b, a) ((r) | ((g) << 8) | ((b) << 16) | ((a) << 24))
    ...
    libattopng_save(png, "./resource/libattopng-test-rgba.png");
    libattopng_destroy(png);
}
...
#define RGBA(r, g, b, a) ((r) | ((g) << 8) | ((b) << 16) | ((a) << 24))
    ...
    // FILE *file = fopen("/Users/hubin/Desktop/libattopng-test-rgba.png", "wb");
    // FILE *file = fopen("C:\\Users\\Administrator\\Desktop\\libattopng-test-rgba", "wb+");
    libattopng_save(png, "./resource/libattopng-test-palette.png");
    libattopng_destroy(png);
}
