...
@REM ffplay -pixel_format yuv444p -video_size 710x711 -framerate 5 ./resource/rainbow_711x711_yuv420p_to_yuv444p.yuv
ffplay -pixel_format yuv420p -video_size 710x711 -framerate 5 ./res/rainbow_711x711_bmp_yuv420p.yuv