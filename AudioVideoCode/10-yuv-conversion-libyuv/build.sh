...
WIDTH=711
HEIGHT=711
# ${RELEASE_DIR}/bin/10-yuv-rotation ${WIDTH} ${HEIGHT}
# ${RELEASE_DIR}/bin/10-yuv-mirror ${WIDTH} ${HEIGHT}
# ${RELEASE_DIR}/bin/10-yuv-scale ${WIDTH} ${HEIGHT}
# ${RELEASE_DIR}/bin/10-yuv-clip ${WIDTH} ${HEIGHT}
# ${RELEASE_DIR}/bin/10-yuv-blend ${WIDTH} ${HEIGHT}
