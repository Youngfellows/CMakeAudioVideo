...
@REM ffplay -pixel_format yuv420p -video_size 200x200 -framerate 5 ./resource/rainbow_711x711_yuv420p_711x711_clip_200x200.yuv
@REM ffplay -pixel_format yuv420p -video_size 100x100 -framerate 5 ./resource/rainbow_711x711_yuv420p_scale_6.yuv
@REM ffplay -pixel_format yuv420p -video_size 710x711 -framerate 5 ./resource/rainbow_711x711_yuv420p_rotation_90.yuv
@REM ffplay -pixel_format yuv420p -video_size 710x711 -framerate 5 ./resource/rainbow_711x711_yuv420p_rotation_90_mirror.yuv
ffplay -pixel_format yuv420p -video_size 710x711 -framerate 5 ./resource/rainbow_711x711_yuv420p_rotation_90_mirror.yuv