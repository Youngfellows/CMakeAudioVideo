...
@REM ffplay -pixel_format yuv420p -video_size 711x711 -framerate 5 ./resource/rainbow-700x700-rgb24-toyuv420p.yuv
ffplay -pixel_format yuv420p -video_size 711x711 -framerate 5 ./resource/rainbow-700x700-yuv444-to-yuv420p.yuv
@REM ffplay -pixel_format yuv444p -video_size 711x711 -framerate 5 ./resource/rainbow-700x700-rgb24-toyuv420p